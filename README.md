...
* [x] **[TRADES]** batchsize (128), learning rate (0.001), epoch (6), beta (1.5)
* [ ] **[MART]** batchsize (128), learning rate (0.001), epoch (6), beta(1)
...
* [ ] **[TRADES]** batchsize (128), learning rate (0.001), epoch (6), beta (1.5)
* [ ] **[MART]** batchsize (128), learning rate (0.001), epoch (6), beta(1)
* [ ] **[AWP]** batchsize (128), learning rate (0.001), epoch (6), beta(5)
* [ ] **[CAFE]** batchsize (128), learning rate (0.001), epoch (6), beta(5)
